...
namespace Ixq.Soft.Core.EventBus
{
    public interface IEventBus
    {
        ...
        IDisposable Register<TEventData>(IEventHandler handler) where TEventData : IEventData;
        ...
        void Unregister<TEventData>(IEventHandler handler) where TEventData : IEventData;
